...
- [ ] разбить код на функции или classы
- [ ] Добавить к залупе весь поиск и сохранить в datу с элементами из search_name:list[str]
- [FIXME] если не находит ссылку нмо то не генерируется финальная ссылка
"""
