...
def main():
	...
	after: ???
	"""
	return search("Современные требования к оформлению заключительного клинического и  патологоанатомического диагнозов. Порядок оформления медицинского свидетельства о смерти",9800)
